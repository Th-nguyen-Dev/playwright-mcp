...
| [TICKET-012](tickets/TICKET-012.md) | Integration tests -- end-to-end tool call to file on disk | P1-High | L | IN PROGRESS | Claude |
| [TICKET-014](tickets/TICKET-014.md) | Integration tests -- iframe stitching and shadow DOM | P1-High | M | IN PROGRESS | Claude |
